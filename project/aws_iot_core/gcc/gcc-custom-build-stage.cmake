...
set(FLASH_PART_CFG_JSON   ${PROJECT_DIR}/cfg/flash_partition_cfg.json)
set(FLASH_PART_TABLE_FILE ${PROJECT_DIR}/cfg/flash_partition_table.h)

execute_process(COMMAND python3 ${FLASH_PYTHON_SCRIPT} -p ${FLASH_PART_CFG_JSON} -o ${FLASH_PART_TABLE_FILE}
  WORKING_DIRECTORY ${PROJECT_DIR}/cfg
)
...
add_custom_target(MakeImage ALL
  COMMAND  python3   ${LN_MKIMAGE}   --sdkroot_dir ${LN_SDK_ROOT}  --userproj_dir  ${PROJECT_DIR} --buildout_dir  ${EXECUTABLE_OUTPUT_PATH}  --buildout_name  ${TARGET_ELF_NAME}  --output flashimage.bin
