...
###################################  joylink   ################################
file(GLOB_RECURSE  JOYLINK_SRC_EXAMPLE  ${COMP_JOYLINKS_DIR}/example/*.c)
file(GLOB_RECURSE  JOYLINK_SRC_PAL  ${COMP_JOYLINKS_DIR}/pal/src/*.c)
file(GLOB_RECURSE  JOYLINK_SRC_LN  ${COMP_JOYLINKS_DIR}/ln/*.c)
include_directories(${COMP_JOYLINKS_DIR}/example)
include_directories(${COMP_JOYLINKS_DIR}/inc)
include_directories(${COMP_JOYLINKS_DIR}/inc/ble)
include_directories(${COMP_JOYLINKS_DIR}/inc/json)
include_directories(${COMP_JOYLINKS_DIR}/inc/softap)
include_directories(${COMP_JOYLINKS_DIR}/pal/inc)
include_directories(${COMP_JOYLINKS_DIR}/ln)
include_directories(${COMP_JOYLINKS_DIR}/ln/ble_usr_app)
include_directories(${COMP_JOYLINKS_DIR}/ln/ble_usr_app/app_callback)
list(APPEND MODULE_SRC ${JOYLINK_SRC_EXAMPLE})
list(APPEND MODULE_SRC ${JOYLINK_SRC_PAL})
list(APPEND MODULE_SRC ${JOYLINK_SRC_LN})
###################################  utils  ####################################
set(UTILS_SRC
