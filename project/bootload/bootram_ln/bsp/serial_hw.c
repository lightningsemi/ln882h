...
{
    //TODO: 
    hal_gpio_afio_select(GPIOA_BASE,GPIO_PIN_3,UART0_TX);
    hal_gpio_afio_select(GPIOA_BASE,GPIO_PIN_4,UART0_RX);
    hal_gpio_afio_select(GPIOA_BASE,GPIO_PIN_5,UART1_TX);
    hal_gpio_afio_select(GPIOA_BASE,GPIO_PIN_6,UART1_RX);

    hal_gpio_afio_en(GPIOA_BASE,GPIO_PIN_3,HAL_ENABLE);
    hal_gpio_afio_en(GPIOA_BASE,GPIO_PIN_4,HAL_ENABLE);
