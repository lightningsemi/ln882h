...
#include "ln882h.h"
#include "usr_app.h"
#include "qcloud_sample_cfg.h"

static OS_Thread_t g_usr_app_thread;
static OS_Thread_t g_temp_cal_thread;
#define USR_APP_TASK_STACK_SIZE    (1024*6) //Byte
#define TEMP_APP_TASK_STACK_SIZE   (1024) //Byte


extern int wifi_config_sample(char *argv);
extern int mqtt_sample(char *argv);
extern int ota_mqtt_sample(char *argv);
...
#ifdef SAMPLE_MQTT
    mqtt_sample(params);
#elif  SAMPLE_DATA_TEMPLATE
#elif  SAMPLE_LIGHT_DATA_TEMPLATE
#elif  SAMPLE_RAW_DATA_MQTT
#elif  SAMPLE_OTA_MQTT_SAMPLE
    ota_mqtt_sample(params);
#elif  SAMPLE_DYN_REG   
#elif  SAMPLE_WIFI_CONFIG
    wifi_config_sample(params);
#else
  #error "Unknown QCloud SAMPLE!!!"
#endif
