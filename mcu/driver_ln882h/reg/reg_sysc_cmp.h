...
__STATIC_INLINE void sysc_cmp_div_update_pack(uint8_t ble_div_para_up, uint8_t rfintf_div_para_up, uint8_t timer4_div_para_up,
                                              uint8_t timer3_div_para_up, uint8_t timer2_div_para_up, uint8_t timer1_div_para_up,
                                              uint8_t pclk0_div_para_up)
{
    hwp_sysc_cmp->div_update.val =
        (((uint32_t) ble_div_para_up << 6) | ((uint32_t) rfintf_div_para_up << 5) | ((uint32_t) timer4_div_para_up << 4) |
         ((uint32_t) timer3_div_para_up << 3) | ((uint32_t) timer2_div_para_up << 2) | ((uint32_t) timer1_div_para_up << 1) |
...
__STATIC_INLINE void sysc_cmp_div_para_pack(uint8_t ble_div_para_m1, uint8_t rfintf_div_para_m1, uint8_t pclk0_div_para_m1)
{
    hwp_sysc_cmp->div_para.val =
        (((uint32_t) ble_div_para_m1 << 5) | ((uint32_t) rfintf_div_para_m1 << 4) | ((uint32_t) pclk0_div_para_m1));
}

__STATIC_INLINE void sysc_cmp_div_para_timer_0_pack(uint8_t timer4_div_para_m1, uint8_t timer3_div_para_m1,
                                                    uint8_t timer2_div_para_m1, uint8_t timer1_div_para_m1)
{
    hwp_sysc_cmp->div_para_timer_0.val = (((uint32_t) timer4_div_para_m1 << 24) | ((uint32_t) timer3_div_para_m1 << 16) |
                                          ((uint32_t) timer2_div_para_m1 << 8) | ((uint32_t) timer1_div_para_m1));
}

__STATIC_INLINE void sysc_cmp_sw_clkg_pack(uint8_t aes_gate_en, uint8_t trng_gate_en, uint8_t ef_gate_en, uint8_t pwm_gate_en,
                                           uint8_t rfreg_gate_en, uint8_t dma_gate_en, uint8_t cache_gate_en, uint8_t mac_gate_en,
                                           uint8_t sdio_gate_en, uint8_t dbgh_gate_en, uint8_t timer4_gate_en,
                                           uint8_t timer3_gate_en, uint8_t timer2_gate_en, uint8_t timer1_gate_en,
                                           uint8_t timer_gate_en, uint8_t wdt_gate_en, uint8_t uart2_gate_en, uint8_t uart1_gate_en,
                                           uint8_t uart0_gate_en, uint8_t i2c0_gate_en, uint8_t ws2811_gate_en,
                                           uint8_t spi1_gate_en, uint8_t spi0_gate_en, uint8_t gpiob_gate_en, uint8_t gpioa_gate_en,
                                           uint8_t i2s_gate_en, uint8_t adcc_gate_en, uint8_t qspi_gate_en)
{
    hwp_sysc_cmp->sw_clkg.val =
        (((uint32_t) aes_gate_en << 28) | ((uint32_t) trng_gate_en << 27) | ((uint32_t) ef_gate_en << 26) |
         ((uint32_t) pwm_gate_en << 25) | ((uint32_t) rfreg_gate_en << 24) | ((uint32_t) dma_gate_en << 23) |
         ((uint32_t) cache_gate_en << 22) | ((uint32_t) mac_gate_en << 21) | ((uint32_t) sdio_gate_en << 20) |
         ((uint32_t) dbgh_gate_en << 19) | ((uint32_t) timer4_gate_en << 18) | ((uint32_t) timer3_gate_en << 17) |
         ((uint32_t) timer2_gate_en << 16) | ((uint32_t) timer1_gate_en << 15) | ((uint32_t) timer_gate_en << 14) |
         ((uint32_t) wdt_gate_en << 13) | ((uint32_t) uart2_gate_en << 12) | ((uint32_t) uart1_gate_en << 11) |
         ((uint32_t) uart0_gate_en << 10) | ((uint32_t) i2c0_gate_en << 9) | ((uint32_t) ws2811_gate_en << 8) |
         ((uint32_t) spi1_gate_en << 7) | ((uint32_t) spi0_gate_en << 6) | ((uint32_t) gpiob_gate_en << 5) |
         ((uint32_t) gpioa_gate_en << 4) | ((uint32_t) i2s_gate_en << 3) | ((uint32_t) adcc_gate_en << 2) |
         ((uint32_t) qspi_gate_en << 1));
}

__STATIC_INLINE void sysc_cmp_sw_rstn_pack(uint8_t srstn_aes, uint8_t srstn_trng, uint8_t srstn_ef, uint8_t srstn_pwm,
                                           uint8_t srstn_rfreg, uint8_t srstn_dma, uint8_t srstn_cache, uint8_t srstn_mac,
                                           uint8_t srstn_sdio, uint8_t srstn_dbgh, uint8_t srstn_timer, uint8_t srstn_wdt,
                                           uint8_t srstn_uart2, uint8_t srstn_uart1, uint8_t srstn_uart0, uint8_t srstn_i2c0,
                                           uint8_t srstn_ws2811, uint8_t srstn_spi1, uint8_t srstn_spi0, uint8_t srstn_gpiob,
                                           uint8_t srstn_gpioa, uint8_t srstn_i2s, uint8_t srstn_adcc, uint8_t srstn_qspi)
{
    hwp_sysc_cmp->sw_rstn.val = (((uint32_t) srstn_aes << 24) | ((uint32_t) srstn_trng << 23) | ((uint32_t) srstn_ef << 22) |
                                 ((uint32_t) srstn_pwm << 21) | ((uint32_t) srstn_rfreg << 20) | ((uint32_t) srstn_dma << 19) |
                                 ((uint32_t) srstn_cache << 18) | ((uint32_t) srstn_mac << 17) | ((uint32_t) srstn_sdio << 16) |
                                 ((uint32_t) srstn_dbgh << 15) | ((uint32_t) srstn_timer << 14) | ((uint32_t) srstn_wdt << 13) |
                                 ((uint32_t) srstn_uart2 << 12) | ((uint32_t) srstn_uart1 << 11) | ((uint32_t) srstn_uart0 << 10) |
                                 ((uint32_t) srstn_i2c0 << 9) | ((uint32_t) srstn_ws2811 << 8) | ((uint32_t) srstn_spi1 << 7) |
                                 ((uint32_t) srstn_spi0 << 6) | ((uint32_t) srstn_gpiob << 5) | ((uint32_t) srstn_gpioa << 4) |
                                 ((uint32_t) srstn_i2s << 3) | ((uint32_t) srstn_adcc << 2) | ((uint32_t) srstn_qspi << 1));
}
...
__STATIC_INLINE void sysc_cmp_io_en_pack(uint8_t i2s_io_en1, uint8_t i2s_io_en0, uint8_t spif_io_en, uint8_t sdio_io_en)
{
    hwp_sysc_cmp->io_en.val =
        (((uint32_t) i2s_io_en1 << 7) | ((uint32_t) i2s_io_en0 << 6) | ((uint32_t) spif_io_en << 5) | ((uint32_t) sdio_io_en << 4));
}

__STATIC_INLINE void sysc_cmp_func_isel_0_pack(uint8_t func_io03_sel, uint8_t func_io02_sel, uint8_t func_io01_sel,
                                               uint8_t func_io00_sel)
{
    hwp_sysc_cmp->func_isel_0.val = (((uint32_t) func_io03_sel << 24) | ((uint32_t) func_io02_sel << 16) |
                                     ((uint32_t) func_io01_sel << 8) | ((uint32_t) func_io00_sel));
}

__STATIC_INLINE void sysc_cmp_func_isel_1_pack(uint8_t func_io07_sel, uint8_t func_io06_sel, uint8_t func_io05_sel,
                                               uint8_t func_io04_sel)
{
    hwp_sysc_cmp->func_isel_1.val = (((uint32_t) func_io07_sel << 24) | ((uint32_t) func_io06_sel << 16) |
                                     ((uint32_t) func_io05_sel << 8) | ((uint32_t) func_io04_sel));
}

__STATIC_INLINE void sysc_cmp_func_isel_2_pack(uint8_t func_io11_sel, uint8_t func_io10_sel, uint8_t func_io09_sel,
                                               uint8_t func_io08_sel)
{
    hwp_sysc_cmp->func_isel_2.val = (((uint32_t) func_io11_sel << 24) | ((uint32_t) func_io10_sel << 16) |
                                     ((uint32_t) func_io09_sel << 8) | ((uint32_t) func_io08_sel));
}

__STATIC_INLINE void sysc_cmp_func_isel_3_pack(uint8_t func_io15_sel, uint8_t func_io14_sel, uint8_t func_io13_sel,
                                               uint8_t func_io12_sel)
{
    hwp_sysc_cmp->func_isel_3.val = (((uint32_t) func_io15_sel << 24) | ((uint32_t) func_io14_sel << 16) |
                                     ((uint32_t) func_io13_sel << 8) | ((uint32_t) func_io12_sel));
}

__STATIC_INLINE void sysc_cmp_func_isel_4_pack(uint8_t func_io19_sel, uint8_t func_io18_sel, uint8_t func_io17_sel,
                                               uint8_t func_io16_sel)
{
    hwp_sysc_cmp->func_isel_4.val = (((uint32_t) func_io19_sel << 24) | ((uint32_t) func_io18_sel << 16) |
                                     ((uint32_t) func_io17_sel << 8) | ((uint32_t) func_io16_sel));
}

__STATIC_INLINE void sysc_cmp_mem_ema_0_pack(uint8_t ram32_ema, uint8_t ram31_ema, uint8_t ram30_ema, uint8_t ram2_ema,
                                             uint8_t ram1_ema, uint8_t ram0_ema, uint8_t rom_ema)
{
    hwp_sysc_cmp->mem_ema_0.val =
        (((uint32_t) ram32_ema << 28) | ((uint32_t) ram31_ema << 24) | ((uint32_t) ram30_ema << 20) | ((uint32_t) ram2_ema << 16) |
         ((uint32_t) ram1_ema << 12) | ((uint32_t) ram0_ema << 8) | ((uint32_t) rom_ema));
}

__STATIC_INLINE void sysc_cmp_mem_ema_1_pack(uint8_t ram35_emaw, uint8_t ram34_emaw, uint8_t ram33_emaw, uint8_t ram32_emaw,
                                             uint8_t ram31_emaw, uint8_t ram30_emaw, uint8_t ram2_emaw, uint8_t ram1_emaw,
                                             uint8_t ram0_emaw, uint8_t ram35_ema, uint8_t ram34_ema, uint8_t ram33_ema)
{
    hwp_sysc_cmp->mem_ema_1.val = (((uint32_t) ram35_emaw << 28) | ((uint32_t) ram34_emaw << 26) | ((uint32_t) ram33_emaw << 24) |
                                   ((uint32_t) ram32_emaw << 22) | ((uint32_t) ram31_emaw << 20) | ((uint32_t) ram30_emaw << 18) |
                                   ((uint32_t) ram2_emaw << 16) | ((uint32_t) ram1_emaw << 14) | ((uint32_t) ram0_emaw << 12) |
                                   ((uint32_t) ram35_ema << 8) | ((uint32_t) ram34_ema << 4) | ((uint32_t) ram33_ema));
}

__STATIC_INLINE void sysc_cmp_clk_test_pack(uint8_t clk_test_sel1, uint8_t clk_test_en1, uint8_t clk_test_sel0,
                                            uint8_t clk_test_en0)
{
    hwp_sysc_cmp->clk_test.val = (((uint32_t) clk_test_sel1 << 5) | ((uint32_t) clk_test_en1 << 4) |
                                  ((uint32_t) clk_test_sel0 << 1) | ((uint32_t) clk_test_en0));
}

__STATIC_INLINE void sysc_cmp_rfreg_cfg_pack(uint16_t rfreg_base_addr, uint16_t rfreg_len)
{
    hwp_sysc_cmp->rfreg_cfg.val = (((uint32_t) rfreg_base_addr << 16) | ((uint32_t) rfreg_len));
}

__STATIC_INLINE void sysc_cmp_rfreg_action_pack(uint8_t rfreg_restore, uint8_t rfreg_save)
{
    hwp_sysc_cmp->rfreg_action.val = (((uint32_t) rfreg_restore << 1) | ((uint32_t) rfreg_save));
}
...
__STATIC_INLINE void sysc_cmp_debug_sel_pack(uint8_t mac_debug_port_sel, uint8_t debug_port_sel, uint16_t debug_sw)
{
    hwp_sysc_cmp->debug_sel.val =
        (((uint32_t) mac_debug_port_sel << 20) | ((uint32_t) debug_port_sel << 16) | ((uint32_t) debug_sw));
}
...
__STATIC_INLINE void sysc_cmp_div_para_timer_0_unpack(uint8_t * timer4_div_para_m1, uint8_t * timer3_div_para_m1,
                                                      uint8_t * timer2_div_para_m1, uint8_t * timer1_div_para_m1)
{
...
__STATIC_INLINE void sysc_cmp_sw_clkg_unpack(
    uint8_t * aes_gate_en, uint8_t * trng_gate_en, uint8_t * ef_gate_en, uint8_t * pwm_gate_en, uint8_t * rfreg_gate_en,
    uint8_t * dma_gate_en, uint8_t * cache_gate_en, uint8_t * mac_gate_en, uint8_t * sdio_gate_en, uint8_t * dbgh_gate_en,
    uint8_t * timer4_gate_en, uint8_t * timer3_gate_en, uint8_t * timer2_gate_en, uint8_t * timer1_gate_en, uint8_t * timer_gate_en,
    uint8_t * wdt_gate_en, uint8_t * uart2_gate_en, uint8_t * uart1_gate_en, uint8_t * uart0_gate_en, uint8_t * i2c0_gate_en,
    uint8_t * ws2811_gate_en, uint8_t * spi1_gate_en, uint8_t * spi0_gate_en, uint8_t * gpiob_gate_en, uint8_t * gpioa_gate_en,
    uint8_t * i2s_gate_en, uint8_t * adcc_gate_en, uint8_t * qspi_gate_en, uint8_t * ble_gate_en)
{
...
__STATIC_INLINE void sysc_cmp_sw_rstn_unpack(uint8_t * srstn_aes, uint8_t * srstn_trng, uint8_t * srstn_ef, uint8_t * srstn_pwm,
                                             uint8_t * srstn_rfreg, uint8_t * srstn_dma, uint8_t * srstn_cache, uint8_t * srstn_mac,
                                             uint8_t * srstn_sdio, uint8_t * srstn_dbgh, uint8_t * srstn_timer, uint8_t * srstn_wdt,
                                             uint8_t * srstn_uart2, uint8_t * srstn_uart1, uint8_t * srstn_uart0,
                                             uint8_t * srstn_i2c0, uint8_t * srstn_ws2811, uint8_t * srstn_spi1,
                                             uint8_t * srstn_spi0, uint8_t * srstn_gpiob, uint8_t * srstn_gpioa,
                                             uint8_t * srstn_i2s, uint8_t * srstn_adcc, uint8_t * srstn_qspi, uint8_t * srstn_ble)
{
...
__STATIC_INLINE void sysc_cmp_func_isel_0_unpack(uint8_t * func_io03_sel, uint8_t * func_io02_sel, uint8_t * func_io01_sel,
                                                 uint8_t * func_io00_sel)
{
...
__STATIC_INLINE void sysc_cmp_func_isel_1_unpack(uint8_t * func_io07_sel, uint8_t * func_io06_sel, uint8_t * func_io05_sel,
                                                 uint8_t * func_io04_sel)
{
...
__STATIC_INLINE void sysc_cmp_func_isel_2_unpack(uint8_t * func_io11_sel, uint8_t * func_io10_sel, uint8_t * func_io09_sel,
                                                 uint8_t * func_io08_sel)
{
...
__STATIC_INLINE void sysc_cmp_func_isel_3_unpack(uint8_t * func_io15_sel, uint8_t * func_io14_sel, uint8_t * func_io13_sel,
                                                 uint8_t * func_io12_sel)
{
...
__STATIC_INLINE void sysc_cmp_func_isel_4_unpack(uint8_t * func_io19_sel, uint8_t * func_io18_sel, uint8_t * func_io17_sel,
                                                 uint8_t * func_io16_sel)
{
...
__STATIC_INLINE void sysc_cmp_mem_ema_0_unpack(uint8_t * ram32_ema, uint8_t * ram31_ema, uint8_t * ram30_ema, uint8_t * ram2_ema,
                                               uint8_t * ram1_ema, uint8_t * ram0_ema, uint8_t * rom_ema)
{
...
__STATIC_INLINE void sysc_cmp_mem_ema_1_unpack(uint8_t * ram35_emaw, uint8_t * ram34_emaw, uint8_t * ram33_emaw,
                                               uint8_t * ram32_emaw, uint8_t * ram31_emaw, uint8_t * ram30_emaw,
                                               uint8_t * ram2_emaw, uint8_t * ram1_emaw, uint8_t * ram0_emaw, uint8_t * ram35_ema,
                                               uint8_t * ram34_ema, uint8_t * ram33_ema)
{
...
__STATIC_INLINE void sysc_cmp_clk_test_unpack(uint8_t * clk_test_sel1, uint8_t * clk_test_en1, uint8_t * clk_test_sel0,
                                              uint8_t * clk_test_en0)
{
