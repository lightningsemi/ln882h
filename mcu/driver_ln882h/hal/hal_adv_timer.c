...
{   
    ...
    hal_assert(IS_TIMER_CAP_EN(adv_tim_init_struct->adv_tim_cap_en));
    hal_assert(IS_TIMER_TIMER_EN(adv_tim_init_struct->adv_tim_tim_en));
    hal_assert(IS_TIMER_DEAD_EN(adv_tim_init_struct->adv_tim_dead_en));
    hal_assert(IS_TIMER_CHA_EN(adv_tim_init_struct->adv_tim_cha_en));
    hal_assert(IS_TIMER_CHB_EN(adv_tim_init_struct->adv_tim_chb_en));
    hal_assert(IS_TIMER_CHB_IT_MODE(adv_tim_init_struct->adv_tim_chb_it_mode));
    hal_assert(IS_TIMER_CHA_IT_MODE(adv_tim_init_struct->adv_tim_cha_it_mode));
    hal_assert(IS_TIMER_ONCE_EN(adv_tim_init_struct->adv_tim_once_en));
    hal_assert(IS_TIMER_CAP_MODE(adv_tim_init_struct->adv_tim_cap_mode));
    hal_assert(IS_TIMER_CAP_EDG(adv_tim_init_struct->adv_tim_cap_edg));
    hal_assert(IS_TIMER_TRG_CLR_EN(adv_tim_init_struct->adv_tim_trg_clr_en));
    hal_assert(IS_TIMER_TRG_SEL(adv_tim_init_struct->adv_tim_trg_sel));
    hal_assert(IS_TIMER_TRG_MODE(adv_tim_init_struct->adv_tim_trg_mode));
    hal_assert(IS_TIMER_CNT_MODE(adv_tim_init_struct->adv_tim_cnt_mode));
    hal_assert(IS_TIMER_CHB_INV_EN(adv_tim_init_struct->adv_tim_chb_inv_en));
    hal_assert(IS_TIMER_CHA_INV_EN(adv_tim_init_struct->adv_tim_cha_inv_en));
    hal_assert(IS_TIMER_LOAD_VALUE(adv_tim_init_struct->adv_tim_load_value));
    hal_assert(IS_TIMER_CMPA_VALUE(adv_tim_init_struct->adv_tim_cmp_a_value));
    hal_assert(IS_TIMER_CMPB_VALUE(adv_tim_init_struct->adv_tim_cmp_b_value));
    hal_assert(IS_TIMER_CLK_DIV(adv_tim_init_struct->adv_tim_clk_div));
    hal_assert(IS_TIMER_DEAD_GAP(adv_tim_init_struct->adv_tim_dead_gap_value));
    hal_assert(IS_TIMER_TRIG_VALUE(adv_tim_init_struct->adv_tim_trig_value));

    // set the adv timer parameters.
    pwm_db_setf(adv_tim_x_base,adv_tim_init_struct->adv_tim_dead_gap_value);
    pwm_load_setf(adv_tim_x_base,adv_tim_init_struct->adv_tim_load_value);
    pwm_cmp_b_setf(adv_tim_x_base,adv_tim_init_struct->adv_tim_cmp_b_value);
    pwm_cmp_a_setf(adv_tim_x_base,adv_tim_init_struct->adv_tim_cmp_a_value);
    pwm_trig_setf(adv_tim_x_base,adv_tim_init_struct->adv_tim_trig_value);
    if (adv_tim_init_struct->adv_tim_cap_en == HAL_DISABLE) {
        pwm_cap_en_setf(adv_tim_x_base,0);
    }
    else if (adv_tim_init_struct->adv_tim_cap_en == HAL_ENABLE) {
        pwm_cap_en_setf(adv_tim_x_base,1);
    }

    if (adv_tim_init_struct->adv_tim_tim_en == HAL_DISABLE) {
        pwm_tim_en_setf(adv_tim_x_base,0);
    }
    else if (adv_tim_init_struct->adv_tim_tim_en == HAL_ENABLE) {
        pwm_tim_en_setf(adv_tim_x_base,1);
    }

    if (adv_tim_init_struct->adv_tim_dead_en == HAL_DISABLE) {
        pwm_dben_setf(adv_tim_x_base,0);
    }
    else if (adv_tim_init_struct->adv_tim_dead_en == HAL_ENABLE) {
        pwm_dben_setf(adv_tim_x_base,1);
    }    

    if (adv_tim_init_struct->adv_tim_cha_en == HAL_DISABLE) {
        pwm_ena_setf(adv_tim_x_base,0);
    }
    else if (adv_tim_init_struct->adv_tim_cha_en == HAL_ENABLE) {
        pwm_ena_setf(adv_tim_x_base,1);
    }      

    if (adv_tim_init_struct->adv_tim_chb_en == HAL_DISABLE) {
        pwm_enb_setf(adv_tim_x_base,0);
    }
    else if (adv_tim_init_struct->adv_tim_chb_en == HAL_ENABLE) {
        pwm_enb_setf(adv_tim_x_base,1);
    }   

    switch (adv_tim_init_struct->adv_tim_chb_it_mode)
    {
    ...
    switch (adv_tim_init_struct->adv_tim_cha_it_mode)
    {
    ...
    if (adv_tim_init_struct->adv_tim_once_en == HAL_DISABLE) {
        pwm_tim_once_setf(adv_tim_x_base,0);
    }
    else if (adv_tim_init_struct->adv_tim_once_en == HAL_ENABLE) {
        pwm_tim_once_setf(adv_tim_x_base,1);
    }  

    pwm_div_setf(adv_tim_x_base,adv_tim_init_struct->adv_tim_clk_div);

    if (adv_tim_init_struct->adv_tim_cap_mode == ADV_TIMER_CAP_MODE_1) {
        pwm_cap_mod_setf(adv_tim_x_base,0);
    }
    else if (adv_tim_init_struct->adv_tim_cap_mode == ADV_TIMER_CAP_MODE_2) {
        pwm_cap_mod_setf(adv_tim_x_base,1);
    } 

    switch (adv_tim_init_struct->adv_tim_cap_edg)
    {
    ...
    if (adv_tim_init_struct->adv_tim_trg_clr_en == HAL_DISABLE) {
        pwm_trig_clr_en_setf(adv_tim_x_base,0);
    }
    else if (adv_tim_init_struct->adv_tim_trg_clr_en == HAL_ENABLE) {
        pwm_trig_clr_en_setf(adv_tim_x_base,1);
    }

    switch (adv_tim_init_struct->adv_tim_trg_mode)
    {
    ...
    if (adv_tim_init_struct->adv_tim_cnt_mode == ADV_TIMER_CNT_MODE_INC) {
        pwm_cnt_mode_setf(adv_tim_x_base,0);
    }
    else if (adv_tim_init_struct->adv_tim_cnt_mode == ADV_TIMER_CNT_MODE_DEC) {
        pwm_cnt_mode_setf(adv_tim_x_base,1);
    }
    else if (adv_tim_init_struct->adv_tim_cnt_mode == ADV_TIMER_CNT_MODE_BOTH) {
        pwm_cnt_mode_setf(adv_tim_x_base,2);
    }

    if (adv_tim_init_struct->adv_tim_chb_inv_en == HAL_DISABLE) {
        pwm_invb_setf(adv_tim_x_base,0);
    }
    else if (adv_tim_init_struct->adv_tim_chb_inv_en == HAL_ENABLE) {
        pwm_invb_setf(adv_tim_x_base,1);
    }

    if (adv_tim_init_struct->adv_tim_cha_inv_en == HAL_DISABLE) {
        pwm_inva_setf(adv_tim_x_base,0);
    }
    else if (adv_tim_init_struct->adv_tim_cha_inv_en == HAL_ENABLE) {
...
uint8_t hal_adv_tim_get_status_flag(uint32_t adv_tim_x_base,adv_tim_status_flag_t adv_tim_status_flag)
{
    ...
    switch (adv_tim_x_base)
    {
        case ADV_TIMER_0_BASE:
        {
            ...
            {
                case ADV_TIMER_STATUS_FLAG_LOAD:
                    status_flag = pwm_isr0_load_getf(ADV_TIMER_IT_BASE);
                    break;
                    
                case ADV_TIMER_STATUS_FLAG_TRIG:
                    status_flag = pwm_isr0_trig_getf(ADV_TIMER_IT_BASE);
                    break;

                case ADV_TIMER_STATUS_FLAG_CMPA:
                    status_flag = pwm_isr0_cmpa_getf(ADV_TIMER_IT_BASE);
                    break;

                case ADV_TIMER_STATUS_FLAG_CMPB:
                    status_flag = pwm_isr0_cmpb_getf(ADV_TIMER_IT_BASE);
        ...
        case ADV_TIMER_1_BASE:
        {
            ...
            {
                case ADV_TIMER_STATUS_FLAG_LOAD:
                    status_flag = pwm_isr1_load_getf(ADV_TIMER_IT_BASE);
                    break;
                    
                case ADV_TIMER_STATUS_FLAG_TRIG:
                    status_flag = pwm_isr1_trig_getf(ADV_TIMER_IT_BASE);
                    break;

                case ADV_TIMER_STATUS_FLAG_CMPA:
                    status_flag = pwm_isr1_cmpa_getf(ADV_TIMER_IT_BASE);
                    break;

                case ADV_TIMER_STATUS_FLAG_CMPB:
                    status_flag = pwm_isr1_cmpb_getf(ADV_TIMER_IT_BASE);
        ...
        case ADV_TIMER_2_BASE:
        {
            ...
            {
                case ADV_TIMER_STATUS_FLAG_LOAD:
                    status_flag = pwm_isr2_load_getf(ADV_TIMER_IT_BASE);
                    break;
                    
                case ADV_TIMER_STATUS_FLAG_TRIG:
                    status_flag = pwm_isr2_trig_getf(ADV_TIMER_IT_BASE);
                    break;

                case ADV_TIMER_STATUS_FLAG_CMPA:
                    status_flag = pwm_isr2_cmpa_getf(ADV_TIMER_IT_BASE);
                    break;

                case ADV_TIMER_STATUS_FLAG_CMPB:
                    status_flag = pwm_isr2_cmpb_getf(ADV_TIMER_IT_BASE);
        ...
        case ADV_TIMER_3_BASE:
        {
            ...
            {
                case ADV_TIMER_STATUS_FLAG_LOAD:
                    status_flag = pwm_isr3_load_getf(ADV_TIMER_IT_BASE);
                    break;
                    
                case ADV_TIMER_STATUS_FLAG_TRIG:
                    status_flag = pwm_isr3_trig_getf(ADV_TIMER_IT_BASE);
                    break;

                case ADV_TIMER_STATUS_FLAG_CMPA:
                    status_flag = pwm_isr3_cmpa_getf(ADV_TIMER_IT_BASE);
                    break;

                case ADV_TIMER_STATUS_FLAG_CMPB:
                    status_flag = pwm_isr3_cmpb_getf(ADV_TIMER_IT_BASE);
        ...
        case ADV_TIMER_4_BASE:
        {
            ...
            {
                case ADV_TIMER_STATUS_FLAG_LOAD:
                    status_flag = pwm_isr4_load_getf(ADV_TIMER_IT_BASE);
                    break;
                    
                case ADV_TIMER_STATUS_FLAG_TRIG:
                    status_flag = pwm_isr4_trig_getf(ADV_TIMER_IT_BASE);
                    break;

                case ADV_TIMER_STATUS_FLAG_CMPA:
                    status_flag = pwm_isr4_cmpa_getf(ADV_TIMER_IT_BASE);
                    break;

                case ADV_TIMER_STATUS_FLAG_CMPB:
                    status_flag = pwm_isr4_cmpb_getf(ADV_TIMER_IT_BASE);
        ...
        case ADV_TIMER_5_BASE:
        {
            ...
            {
                case ADV_TIMER_STATUS_FLAG_LOAD:
                    status_flag = pwm_isr5_load_getf(ADV_TIMER_IT_BASE);
                    break;
                    
                case ADV_TIMER_STATUS_FLAG_TRIG:
                    status_flag = pwm_isr5_trig_getf(ADV_TIMER_IT_BASE);
                    break;

                case ADV_TIMER_STATUS_FLAG_CMPA:
                    status_flag = pwm_isr5_cmpa_getf(ADV_TIMER_IT_BASE);
                    break;

                case ADV_TIMER_STATUS_FLAG_CMPB:
                    status_flag = pwm_isr5_cmpb_getf(ADV_TIMER_IT_BASE);
