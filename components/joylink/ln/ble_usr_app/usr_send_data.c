...
//#define LN_JL_SERVICE       0x00,0x00,0xFE,0x70,0x00,0x00,0x10,0x00,0x80,0x00,0x00,0x80,0x5F,0x9B,0x34,0xFB
//#define LN_JL_WRITE         0x00,0x00,0xFE,0x71,0x00,0x00,0x10,0x00,0x80,0x00,0x00,0x80,0x5F,0x9B,0x34,0xFB
//#define LN_JL_INDICATE      0x00,0x00,0xFE,0x72,0x00,0x00,0x10,0x00,0x80,0x00,0x00,0x80,0x5F,0x9B,0x34,0xFB
#define LN_JL_SERVICE       0xFB,0x34,0x9B,0x5F,0x80,0x00,0x00,0x80,0x00,0x10,0x00,0x00,0x70,0xFE,0x00,0x00
#define LN_JL_WRITE         0xFB,0x34,0x9B,0x5F,0x80,0x00,0x00,0x80,0x00,0x10,0x00,0x00,0x71,0xFE,0x00,0x00
#define LN_JL_INDICATE      0xFB,0x34,0x9B,0x5F,0x80,0x00,0x00,0x80,0x00,0x10,0x00,0x00,0x72,0xFE,0x00,0x00
...
static const struct gattm_att_desc  data_trans_atts[] = {
    ...
    [DATA_TRANS_CHAR_VAL_TX] = {
        .uuid = {LN_JL_INDICATE}, 
        .perm = PERM_MASK_IND|PERM_MASK_RD,
        .max_len = DATA_TRANS_MAX_LEN,
        .ext_perm =  (2 << PERM_POS_UUID_LEN),
    },
...
uint8_t svc_uuid[16]={LN_JL_SERVICE};

void data_trans_svc_add(void)
{
    int nb_att = sizeof(data_trans_atts)/sizeof(data_trans_atts[0]);
    jl_gatt_data_t gatt_data={0};

    //jl_get_gatt_config_data(&gatt_data);
