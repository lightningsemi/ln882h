 ...
 * </pre>
 */
#define EM_BLE_TXISOPTR_ADDR   (0x40430000 + EM_BLE_TX_ISO_DESC_OFFSET)
#define EM_BLE_TXISOPTR_INDEX  0x00000000
#define EM_BLE_TXISOPTR_RESET  0x00000000

__STATIC_INLINE__ uint16_t em_ble_txisoptr_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_TXISOPTR_ADDR + elt_idx * REG_EM_BLE_TX_ISO_DESC_SIZE);
}

__STATIC_INLINE__ void em_ble_txisoptr_set(int elt_idx, uint16_t value)
{
...
__STATIC_INLINE__ void em_ble_txisoptr_pack(int elt_idx, uint8_t txdone, uint16_t nextptr)
{
...
__STATIC_INLINE__ void em_ble_txisoptr_unpack(int elt_idx, uint8_t* txdone, uint16_t* nextptr)
{
...
__STATIC_INLINE__ uint8_t em_ble_txisoptr_txdone_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXISOPTR_ADDR + elt_idx * REG_EM_BLE_TX_ISO_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00008000)) >> 15);
}

__STATIC_INLINE__ void em_ble_txisoptr_txdone_setf(int elt_idx, uint8_t txdone)
{
    ASSERT_ERR((((uint16_t)txdone << 15) & ~((uint16_t)0x00008000)) == 0);
...
__STATIC_INLINE__ uint16_t em_ble_txisoptr_next_ptr_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXISOPTR_ADDR + elt_idx * REG_EM_BLE_TX_ISO_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00003FFF)) >> 0);
}

__STATIC_INLINE__ void em_ble_txisoptr_next_ptr_setf(int elt_idx, uint16_t nextptr)
{
    ASSERT_ERR((((uint16_t)nextptr << 0) & ~((uint16_t)0x00003FFF)) == 0);
 ...
 * </pre>
 */
#define EM_BLE_TXISOCNT0_ADDR   (0x40430002 + EM_BLE_TX_ISO_DESC_OFFSET)
#define EM_BLE_TXISOCNT0_INDEX  0x00000001
#define EM_BLE_TXISOCNT0_RESET  0x00000000

__STATIC_INLINE__ uint16_t em_ble_txisocnt0_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_TXISOCNT0_ADDR + elt_idx * REG_EM_BLE_TX_ISO_DESC_SIZE);
}

__STATIC_INLINE__ void em_ble_txisocnt0_set(int elt_idx, uint16_t value)
{
...
__STATIC_INLINE__ uint16_t em_ble_txisocnt0_txpld_cnt0_getf(int elt_idx)
{
...
__STATIC_INLINE__ void em_ble_txisocnt0_txpld_cnt0_setf(int elt_idx, uint16_t txpldcnt0)
{
 ...
 * </pre>
 */
#define EM_BLE_TXISOCNT1_ADDR   (0x40430004 + EM_BLE_TX_ISO_DESC_OFFSET)
#define EM_BLE_TXISOCNT1_INDEX  0x00000002
#define EM_BLE_TXISOCNT1_RESET  0x00000000

__STATIC_INLINE__ uint16_t em_ble_txisocnt1_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_TXISOCNT1_ADDR + elt_idx * REG_EM_BLE_TX_ISO_DESC_SIZE);
}

__STATIC_INLINE__ void em_ble_txisocnt1_set(int elt_idx, uint16_t value)
{
...
__STATIC_INLINE__ uint16_t em_ble_txisocnt1_txpld_cnt1_getf(int elt_idx)
{
...
__STATIC_INLINE__ void em_ble_txisocnt1_txpld_cnt1_setf(int elt_idx, uint16_t txpldcnt1)
{
 ...
 * </pre>
 */
#define EM_BLE_TXISOCNT2_ADDR   (0x40430006 + EM_BLE_TX_ISO_DESC_OFFSET)
#define EM_BLE_TXISOCNT2_INDEX  0x00000003
#define EM_BLE_TXISOCNT2_RESET  0x00000000

__STATIC_INLINE__ uint16_t em_ble_txisocnt2_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_TXISOCNT2_ADDR + elt_idx * REG_EM_BLE_TX_ISO_DESC_SIZE);
}

__STATIC_INLINE__ void em_ble_txisocnt2_set(int elt_idx, uint16_t value)
{
...
__STATIC_INLINE__ void em_ble_txisocnt2_pack(int elt_idx, uint8_t txflushinstant, uint8_t txisocnt2)
{
...
__STATIC_INLINE__ void em_ble_txisocnt2_unpack(int elt_idx, uint8_t* txflushinstant, uint8_t* txisocnt2)
{
...
__STATIC_INLINE__ uint8_t em_ble_txisocnt2_txflushinstant_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXISOCNT2_ADDR + elt_idx * REG_EM_BLE_TX_ISO_DESC_SIZE);
    return ((localVal & ((uint16_t)0x0000FF00)) >> 8);
}

__STATIC_INLINE__ void em_ble_txisocnt2_txflushinstant_setf(int elt_idx, uint8_t txflushinstant)
{
    ASSERT_ERR((((uint16_t)txflushinstant << 8) & ~((uint16_t)0x0000FF00)) == 0);
...
__STATIC_INLINE__ uint8_t em_ble_txisocnt2_txisocnt2_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXISOCNT2_ADDR + elt_idx * REG_EM_BLE_TX_ISO_DESC_SIZE);
    return ((localVal & ((uint16_t)0x0000007F)) >> 0);
}

__STATIC_INLINE__ void em_ble_txisocnt2_txisocnt2_setf(int elt_idx, uint8_t txisocnt2)
{
    ASSERT_ERR((((uint16_t)txisocnt2 << 0) & ~((uint16_t)0x0000007F)) == 0);
 ...
 * </pre>
 */
#define EM_BLE_TXISOPHM0_ADDR   (0x40430008 + EM_BLE_TX_ISO_DESC_OFFSET)
#define EM_BLE_TXISOPHM0_INDEX  0x00000004
#define EM_BLE_TXISOPHM0_RESET  0x00000000

__STATIC_INLINE__ uint16_t em_ble_txisophm0_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_TXISOPHM0_ADDR + elt_idx * REG_EM_BLE_TX_ISO_DESC_SIZE);
}

__STATIC_INLINE__ void em_ble_txisophm0_set(int elt_idx, uint16_t value)
{
...
__STATIC_INLINE__ void em_ble_txisophm0_pack(int elt_idx, uint8_t txisom0rfu, uint8_t txmd, uint8_t txsn, uint8_t txnesn, uint8_t txllid)
{
...
__STATIC_INLINE__ void em_ble_txisophm0_unpack(int elt_idx, uint8_t* txisom0rfu, uint8_t* txmd, uint8_t* txsn, uint8_t* txnesn, uint8_t* txllid)
{
...
__STATIC_INLINE__ uint8_t em_ble_txisophm0_txisom0rfu_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXISOPHM0_ADDR + elt_idx * REG_EM_BLE_TX_ISO_DESC_SIZE);
    return ((localVal & ((uint16_t)0x000000E0)) >> 5);
}

__STATIC_INLINE__ void em_ble_txisophm0_txisom0rfu_setf(int elt_idx, uint8_t txisom0rfu)
{
    ASSERT_ERR((((uint16_t)txisom0rfu << 5) & ~((uint16_t)0x000000E0)) == 0);
...
__STATIC_INLINE__ uint8_t em_ble_txisophm0_txmd_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXISOPHM0_ADDR + elt_idx * REG_EM_BLE_TX_ISO_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000010)) >> 4);
}

__STATIC_INLINE__ void em_ble_txisophm0_txmd_setf(int elt_idx, uint8_t txmd)
{
    ASSERT_ERR((((uint16_t)txmd << 4) & ~((uint16_t)0x00000010)) == 0);
...
__STATIC_INLINE__ uint8_t em_ble_txisophm0_txsn_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXISOPHM0_ADDR + elt_idx * REG_EM_BLE_TX_ISO_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000008)) >> 3);
}

__STATIC_INLINE__ void em_ble_txisophm0_txsn_setf(int elt_idx, uint8_t txsn)
{
    ASSERT_ERR((((uint16_t)txsn << 3) & ~((uint16_t)0x00000008)) == 0);
...
__STATIC_INLINE__ uint8_t em_ble_txisophm0_txnesn_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXISOPHM0_ADDR + elt_idx * REG_EM_BLE_TX_ISO_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000004)) >> 2);
}

__STATIC_INLINE__ void em_ble_txisophm0_txnesn_setf(int elt_idx, uint8_t txnesn)
{
    ASSERT_ERR((((uint16_t)txnesn << 2) & ~((uint16_t)0x00000004)) == 0);
...
__STATIC_INLINE__ uint8_t em_ble_txisophm0_txllid_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_TXISOPHM0_ADDR + elt_idx * REG_EM_BLE_TX_ISO_DESC_SIZE);
    return ((localVal & ((uint16_t)0x00000003)) >> 0);
}

__STATIC_INLINE__ void em_ble_txisophm0_txllid_setf(int elt_idx, uint8_t txllid)
{
    ASSERT_ERR((((uint16_t)txllid << 0) & ~((uint16_t)0x00000003)) == 0);
 ...
 * </pre>
 */
#define EM_BLE_TXISOBUFPTR_ADDR   (0x4043000A + EM_BLE_TX_ISO_DESC_OFFSET)
#define EM_BLE_TXISOBUFPTR_INDEX  0x00000005
#define EM_BLE_TXISOBUFPTR_RESET  0x00000000

__STATIC_INLINE__ uint16_t em_ble_txisobufptr_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_TXISOBUFPTR_ADDR + elt_idx * REG_EM_BLE_TX_ISO_DESC_SIZE);
}

__STATIC_INLINE__ void em_ble_txisobufptr_set(int elt_idx, uint16_t value)
{
...
__STATIC_INLINE__ uint16_t em_ble_txisobufptr_getf(int elt_idx)
{
...
__STATIC_INLINE__ void em_ble_txisobufptr_setf(int elt_idx, uint16_t txisobufptr)
{
