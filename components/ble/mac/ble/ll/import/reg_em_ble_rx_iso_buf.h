 ...
 * </pre>
 */
#define EM_BLE_RXISOBUFSTAT_ADDR   (0x40430000 + EM_BLE_RX_ISO_BUF_OFFSET)
#define EM_BLE_RXISOBUFSTAT_INDEX  0x00000000
#define EM_BLE_RXISOBUFSTAT_RESET  0x00000000

__STATIC_INLINE__ uint16_t em_ble_rxisobufstat_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_RXISOBUFSTAT_ADDR + elt_idx * REG_EM_BLE_RX_ISO_BUF_SIZE);
}

__STATIC_INLINE__ void em_ble_rxisobufstat_set(int elt_idx, uint16_t value)
{
...
__STATIC_INLINE__ void em_ble_rxisobufstat_pack(int elt_idx, uint8_t invl, uint8_t rxisolength)
{
...
__STATIC_INLINE__ void em_ble_rxisobufstat_unpack(int elt_idx, uint8_t* invl, uint8_t* rxisolength)
{
...
__STATIC_INLINE__ uint8_t em_ble_rxisobufstat_invl_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXISOBUFSTAT_ADDR + elt_idx * REG_EM_BLE_RX_ISO_BUF_SIZE);
    return ((localVal & ((uint16_t)0x0000C000)) >> 14);
}

__STATIC_INLINE__ void em_ble_rxisobufstat_invl_setf(int elt_idx, uint8_t invl)
{
    ASSERT_ERR((((uint16_t)invl << 14) & ~((uint16_t)0x0000C000)) == 0);
...
__STATIC_INLINE__ uint8_t em_ble_rxisobufstat_rxisolength_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXISOBUFSTAT_ADDR + elt_idx * REG_EM_BLE_RX_ISO_BUF_SIZE);
    return ((localVal & ((uint16_t)0x000000FF)) >> 0);
}

__STATIC_INLINE__ void em_ble_rxisobufstat_rxisolength_setf(int elt_idx, uint8_t rxisolength)
{
    ASSERT_ERR((((uint16_t)rxisolength << 0) & ~((uint16_t)0x000000FF)) == 0);
 ...
 * </pre>
 */
#define EM_BLE_RXISOBUFLBL_ADDR   (0x40430002 + EM_BLE_RX_ISO_BUF_OFFSET)
#define EM_BLE_RXISOBUFLBL_INDEX  0x00000001
#define EM_BLE_RXISOBUFLBL_RESET  0x00000000

__STATIC_INLINE__ uint16_t em_ble_rxisobuflbl_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_RXISOBUFLBL_ADDR + elt_idx * REG_EM_BLE_RX_ISO_BUF_SIZE);
}

__STATIC_INLINE__ void em_ble_rxisobuflbl_set(int elt_idx, uint16_t value)
{
...
__STATIC_INLINE__ void em_ble_rxisobuflbl_pack(int elt_idx, uint8_t rxbuflinklbl, uint8_t rxbufstreamlbl, uint8_t rxbufgrouplbl)
{
...
__STATIC_INLINE__ void em_ble_rxisobuflbl_unpack(int elt_idx, uint8_t* rxbuflinklbl, uint8_t* rxbufstreamlbl, uint8_t* rxbufgrouplbl)
{
...
__STATIC_INLINE__ uint8_t em_ble_rxisobuflbl_rxbuflinklbl_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXISOBUFLBL_ADDR + elt_idx * REG_EM_BLE_RX_ISO_BUF_SIZE);
    return ((localVal & ((uint16_t)0x00001F00)) >> 8);
}

__STATIC_INLINE__ void em_ble_rxisobuflbl_rxbuflinklbl_setf(int elt_idx, uint8_t rxbuflinklbl)
{
    ASSERT_ERR((((uint16_t)rxbuflinklbl << 8) & ~((uint16_t)0x00001F00)) == 0);
...
__STATIC_INLINE__ uint8_t em_ble_rxisobuflbl_rxbufstream_lbl_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXISOBUFLBL_ADDR + elt_idx * REG_EM_BLE_RX_ISO_BUF_SIZE);
    return ((localVal & ((uint16_t)0x000000F8)) >> 3);
}

__STATIC_INLINE__ void em_ble_rxisobuflbl_rxbufstream_lbl_setf(int elt_idx, uint8_t rxbufstreamlbl)
{
    ASSERT_ERR((((uint16_t)rxbufstreamlbl << 3) & ~((uint16_t)0x000000F8)) == 0);
...
__STATIC_INLINE__ uint8_t em_ble_rxisobuflbl_rxbufgroup_lbl_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(EM_BLE_RXISOBUFLBL_ADDR + elt_idx * REG_EM_BLE_RX_ISO_BUF_SIZE);
    return ((localVal & ((uint16_t)0x00000007)) >> 0);
}

__STATIC_INLINE__ void em_ble_rxisobuflbl_rxbufgroup_lbl_setf(int elt_idx, uint8_t rxbufgrouplbl)
{
    ASSERT_ERR((((uint16_t)rxbufgrouplbl << 0) & ~((uint16_t)0x00000007)) == 0);
 ...
 * </pre>
 */
#define EM_BLE_RXISOSUBEVTCNT_ADDR   (0x40430004 + EM_BLE_RX_ISO_BUF_OFFSET)
#define EM_BLE_RXISOSUBEVTCNT_INDEX  0x00000002
#define EM_BLE_RXISOSUBEVTCNT_RESET  0x00000000

__STATIC_INLINE__ uint16_t em_ble_rxisosubevtcnt_get(int elt_idx)
{
    return EM_BLE_RD(EM_BLE_RXISOSUBEVTCNT_ADDR + elt_idx * REG_EM_BLE_RX_ISO_BUF_SIZE);
}

__STATIC_INLINE__ void em_ble_rxisosubevtcnt_set(int elt_idx, uint16_t value)
{
...
__STATIC_INLINE__ uint8_t em_ble_rxisosubevtcnt_subevtcnt_getf(int elt_idx)
{
...
__STATIC_INLINE__ void em_ble_rxisosubevtcnt_subevtcnt_setf(int elt_idx, uint8_t subevtcnt)
{
 ...
 * </pre>
 */
#define EM_BLE_RXISODATABUF_ADDR   (0x40430006 + EM_BLE_RX_ISO_BUF_OFFSET)
...
__STATIC_INLINE__ uint16_t em_ble_rxisodatabuf_get(int elt_idx, int reg_idx)
{
    ASSERT_ERR(reg_idx <= 30);
    return EM_BLE_RD(EM_BLE_RXISODATABUF_ADDR + elt_idx * REG_EM_BLE_RX_ISO_BUF_SIZE + reg_idx * 2);
}

__STATIC_INLINE__ void em_ble_rxisodatabuf_set(int elt_idx, int reg_idx, uint16_t value)
{
    ASSERT_ERR(reg_idx <= 30);
...
__STATIC_INLINE__ uint16_t em_ble_rxisodatabuf_getf(int elt_idx, int reg_idx)
{
    ASSERT_ERR(reg_idx <= 30);
...
__STATIC_INLINE__ void em_ble_rxisodatabuf_setf(int elt_idx, int reg_idx, uint16_t rxisodatabuf)
{
    ASSERT_ERR(reg_idx <= 30);
