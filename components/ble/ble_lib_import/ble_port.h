...
void   blib_assert(int expr, const char *fun, int line);
...
#define BLIB_LOG_LEVEL_CFG        BLIB_LOG_LVL_D
...
#define BLIB_ASSERT(expr)         blib_assert((int)expr, __func__, __LINE__)
