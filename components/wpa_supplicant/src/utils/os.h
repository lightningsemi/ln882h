...
#else /* WPA_TRACE */
#ifndef os_malloc
#define os_malloc(s) OS_Malloc((s))
#endif
#ifndef os_realloc
extern void *ln_wolf_realloc(void *old, int newlen);
#define os_realloc(p, s) ln_wolf_realloc((p), (s))
#endif
#ifndef os_free
#define os_free(p) OS_Free((p))
#endif
extern void *ln_wolf_calloc(int nmemb, int size);
#define os_zalloc(size) ln_wolf_calloc(1, size)
#define os_calloc(nmemb, size) ln_wolf_calloc(nmemb, size)
