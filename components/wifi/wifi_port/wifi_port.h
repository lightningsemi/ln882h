...
#define BLIB_LOG_E(...)           wlib_log_printf(1, WLIB_LOG_LVL_E, __VA_ARGS__)
#define BLIB_LOG_I(...)           wlib_log_printf(1, WLIB_LOG_LVL_I, __VA_ARGS__)
#define BLIB_LOG_W(...)           wlib_log_printf(1, WLIB_LOG_LVL_W, __VA_ARGS__)
#define BLIB_LOG_D(...)           wlib_log_printf(1, WLIB_LOG_LVL_D, __VA_ARGS__)
