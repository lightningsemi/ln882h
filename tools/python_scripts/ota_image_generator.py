...
@description: OTATOOL image generator.
            Only one parameter is required, that is the absolute path to flashimage.bin;
            The output OTA image file is stored in the same directory as the flashimage.bin.
"""
